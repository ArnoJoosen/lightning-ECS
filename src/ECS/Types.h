...
namespace lightning {
    namespace ECS {
        ...
        // tag definition
        #define DEFINE_TAG(name, value) static const lightning::ECS::Tag_t name = ((value) & 0x7FFFFFFF)
        // exclude tag
        #define EXCLUDE_TAG(value) ((value) | 0x80000000)
        #define GET_TAG(value) ((value) & 0x7FFFFFFF)
